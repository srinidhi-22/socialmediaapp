      ...
      <div className="shareWrapper">
        <div className="shareTop">
          ...
          {/* <img
            src={
              hasProfilePicture
                ? currentUser.photoURL // Use the URL of the uploaded profile picture if available
                : currentUser.displayName
                ? `https://ui-avatars.com/api/?name=${encodeURIComponent(
                    currentUser.displayName
                  )}&background=random&size=128` // Use a service like ui-avatars.com to generate an avatar with the first letter of the username
                : getDefaultProfileImageUrl() // Use the default profile image if the user has no username
            }
            alt=""
